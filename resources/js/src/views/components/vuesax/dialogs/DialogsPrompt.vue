...
<template>
    <vx-card title="Prompt" code-toggler>
        ...
        <p>To add a dialog of type prompt we have a global function a completely independent component
            <code>vs-prompt</code>. This allows more flexibility with the input and ability to add any type of input and
            components</p>

        <div class="my-3">
            <span>The properties of the component are equivalent to those of the global function only with the vs before
                each property something like</span>
        ...
        <vs-prompt @cancel="val=''" @accept="acceptAlert" @close="close" :active.sync="activePrompt">
        ...
        <vs-prompt @cancel="clearValMultiple" @accept="acceptAlert" @close="close" :is-valid="validName"
        ...
        <template slot="codeContainer">
            &lt;template&gt;
            &lt;div class=&quot;demo-alignment&quot;&gt;
            &lt;vs-button @click=&quot;activePrompt = true&quot; color=&quot;primary&quot;
            type=&quot;border&quot;&gt;Run prompt&lt;/vs-button&gt;
            &lt;vs-button @click=&quot;activePrompt2 = true&quot; color=&quot;primary&quot;
            type=&quot;border&quot;&gt;Run prompt inputs&lt;/vs-button&gt;
            &lt;div class=&quot;op-block&quot;&gt;Security Code: {{ "\{\{ val == null ? 'null' : val \}\}" }}
            &lt;/div&gt;
            &lt;div class=&quot;op-block&quot;&gt;
            ...
            &lt;div class=&quot;con-exemple-prompt&quot;&gt;
            Enter your first and last name to &lt;b&gt;continue&lt;/b&gt;.
            &lt;vs-input placeholder=&quot;Name&quot; v-model=&quot;valMultipe.value1&quot; class=&quot;mt-4 mb-2
            w-full&quot; /&gt;
