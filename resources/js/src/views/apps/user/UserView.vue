            ...
            <vx-card title="Account" class="mb-base">
                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col flex-1" id="account-info-col-2">
                        <table>
                            <tr>
                                <td class="font-semibold">Actived</td>
                                <td>{{ user_data.active }}</td>
                            </tr>
                            <tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            confirmDeleteRecord() {
                this.$vs.dialog({
                    ...
                    text: `You are about to delete "${this.user_data.full_name}"`,
        ...
        created() {
            ...
            this.$store.dispatch("userManagement/fetchUser", userId).then(respose => {
                this.user_data = respose.data
            }).catch(err => {
