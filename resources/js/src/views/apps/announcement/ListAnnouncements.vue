                        ...
                        <div class="flex flex-wrap">
                            ...
                            <ais-sort-by :items="[
                                ...
                                <vs-select :value="currentRefinement" slot-scope="{ items, currentRefinement, refine }"
                                    ...
                                    <vs-select-item v-for="item in items" :key="item.value" :value="item.value"
                                        :text="item.label" />
                                </vs-select>
                            </ais-sort-by>
                    ...
                    <div class="p-6 filter-container">
                            ...
                            <div slot-scope="{ items, refine, }">
                                <ul>
                                    <li v-for="item in items" :key="item.value"
                                        class="flex items-center cursor-pointer py-1" @click="refine(item.value)">
                              ...
                              refine,
                                ...
                                <ul>
                                    ...
                                    <li v-for="item in items" :key="item.value"
                                        ...
                                        <vs-checkbox v-model="item.isRefined" class="ml-0" @click="refine(item.value)">
                        ...
                        <ais-clear-refinements class="flex justify-center">
                            <vs-button class="w-full" slot-scope="{ canRefine, refine, createURL }"
                                @click.prevent="refine" :disabled="!canRefine">Remove Filters</vs-button>
                        ...
                        <div slot-scope="{ items }">
                            ...
                            <template v-if="currentItemView == 'item-grid-view'">
                                <div class="items-grid-view vx-row match-height">
                                    <div class="vx-col lg:w-1/3 sm:w-1/2 w-full" v-for="item in announcements" :key="item.id">
                                            ...
                                            <template slot="action-buttons">
                                                <div class="flex flex-wrap">
                                                    ...
                                                    <div class="item-view-primary-action-btn p-3 flex flex-grow items-center justify-center cursor-pointer"
                                                        ...
                                                        <router-link :to="{ name: 'admin-announcement-show', params:{ id: item.id } }">
