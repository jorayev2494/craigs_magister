    ...
    <div id="data-list-list-view" class="data-list-container">
        ...
        <vs-table ref="table" v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
            ...
            <template slot="thead">
                ...
                <vs-th sort-key="announcements">Announcements</vs-th>
            ...
            <template slot-scope="{ data }">
                <tbody>
                    <vs-tr :data="category" :key="index" v-for="(category, index) in products">

                        <vs-td>
                            <p class="product-category">{{ category.slug | title }}</p>
                        </vs-td>

                        <vs-td>
                            <p class="product-name font-medium truncate">{{ category.slug }}</p>
                        </vs-td>

                        <vs-td>
                            <p class="product-category">{{ category.model | title }}</p>
                        </vs-td>

                        <!-- <vs-td>
                            <vs-progress :percent="Number(category.popularity)"
                                :color="getPopularityColor(Number(category.popularity))" class="shadow-md" />
                        </vs-td> -->

                        <vs-td>
                            <vs-chip :color="getOrderStatusColor(category.unblock_date)" class="product-order-status">
                                {{ category.unblock_date ? category.unblock_date : 'active' | title }}
                            </vs-chip>
                        </vs-td>
                        ...
                        <vs-td class="whitespace-no-wrap">
                            <feather-icon 
                                ...
                                @click.stop="editData(category)" />
                            <feather-icon 
                                icon="TrashIcon" 
                                svgClasses="w-5 h-5 hover:text-danger stroke-current"
                                class="ml-2" 
                                @click.stop="deleteData($event, category.id)" />
                        </vs-td>
...
<script>
    import DataViewSidebar from '../../../../includes/admin/management/category/CategoryViewSidebar.vue'
    ...
    export default {
        ...
        methods: {
            ...
            deleteData(event, id) {
                ...
                this.$http.delete(`/api/admin/managements/categories/${id}`).then((response) => {
            ...
            getOrderStatusColor(unblock_date) {
