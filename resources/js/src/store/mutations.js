...
const mutations = {
    ...
    UPDATE_USER_INFO(state, payload) {
        ...
        let userInfo = JSON.parse(window.localStorage.getItem("userInfo")) || state.AppActiveUser;

        for (const property of Object.keys(payload)) {
            // Set default avatar
            if (property == 'avatar' && payload[property] == 'default.jpg') {
                payload[property]= '/images/' + 'avatar-s-6.jpg';
                console.table(payload[property]);
            }
