            ...
            <div class="row mb30">
                <div class="col-lg-7 col-xl-8">
                    <div class="single_property_title mt30-767">
                        ...
                        <p>{{ announcement.location.country }}, {{ announcement.location.city }}</p>
                    </div>
                    <div class="dn db-991">
                        <div id="main2">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="spls_style_two mb30-520">
                                <a class="popup-img" :href="getBigImgCom">
                ...
                <div class="col-sm-5 col-lg-4">
                    <div class="row" v-if="fiveImgs.length > 1">
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="spls_style_two mb30">
                                <a class="popup-img" :href="sexsImage.img">
