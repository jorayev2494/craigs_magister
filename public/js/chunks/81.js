...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    RegisterJwt: __webpack_require__(/*! ./RegisterJWT.vue */ "./resources/js/src/views/pages/register/RegisterJWT.vue")["default"]
  }
});
                        ...
                        [
                          _c("div", { staticClass: "vx-card__title mb-4" }, [
                            ...
                            _c("p", [
                              _vm._v(
                                _vm._s(
                                  _vm.$t("fillTheBelowFormToCreateANewAccount")
                                )
                              )
                            ])
                          ]),
    ...
    [
      _c("vs-input", {
        ...
        attrs: {
          ...
          "label-placeholder": _vm.$t("first_name"),
          name: "firs_name",
        ...
        model: {
          ...
          expression: "firs_name"
        }
      }),
      _vm._v(" "),
      _c("span", { staticClass: "text-danger text-sm" }, [
        _vm._v(_vm._s(_vm.errors.first("firs_name")))
      ]),
      _vm._v(" "),
      _c("vs-input", {
        directives: [
        ...
        attrs: {
          "data-vv-validate-on": "blur",
          "label-placeholder": _vm.$t("last_name"),
          name: "last_name",
      ...
      _c("vs-input", {
        ...
        attrs: {
          ...
          placeholder: _vm.$t("password_confirm")
        },
        model: {
      ...
      _c(
        ...
        [_vm._v(_vm._s(_vm.$t("iAcceptTheTermsAndConditions")))]
      ),
      _vm._v(" "),
      _c(
        "vs-button",
        {
          staticClass: "mt-6",
          attrs: { type: "border", to: { name: "admin-page-login" } }
        },
