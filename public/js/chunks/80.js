...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    LoginJwt: __webpack_require__(/*! ./LoginJWT.vue */ "./resources/js/src/views/pages/login/LoginJWT.vue")["default"]
  }
});
  ...
  methods: {
    ...
    loginJWT: function loginJWT() {
      ...
      this.$store.dispatch('auth/loginJWT', payload).then(function () {
        ...
        // console.table(error);
        _this.$vs.loading.close(); // this.$vs.notify({
        //     title: 'Error',
        //     text: error.message,
        //     iconPack: 'feather',
        //     icon: 'icon-alert-circle',
    ...
    [
        ...
        directives: [
          {
            name: "validate",
            rawName: "v-validate",
            value: "required|min:6|max:50",
            expression: "'required|min:6|max:50'"
          }
        ],
      ...
      _c(
        ...
        [
          ...
          _c(
            "router-link",
            { attrs: { to: { name: "admin-page-forgot-password" } } },
